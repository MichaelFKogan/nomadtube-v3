    ...
    return (
        ...
        <div className={`cards-wrapper ${layout}`}>
            ...
            <button className="full-width-btn mobile" onClick={() => {toggleLayout();}}>
                ...
                {layout === 'grid' && (
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-rectangle-horizontal"><rect width="20" height="12" x="2" y="6" rx="2"/></svg>
                )} 
