...
function EuropeDesktopMenu({mobileMenu, closeMobileMenu, toggleEuropeMenu, europeMenu, closeCountryMenus, back, closeAllMenus}) {

  
    return (
    <>        
        <div className={`mobile-menu desktop-menu europe-menu ${europeMenu ? 'd-flex' : 'd-none' }`} style={{paddingTop: "0px"}}>
