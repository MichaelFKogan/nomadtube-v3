...
function SouthAmericaDesktopMenu({mobileMenu, closeMobileMenu, toggleSouthAmericaMenu, southAmericaMenu, closeCountryMenus, back, closeAllMenus, className}) {
...
export default SouthAmericaDesktopMenu;