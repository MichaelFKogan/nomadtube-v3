...
function App() {
  ...
  return (
    <div className="App">
      <Router>
        <Navbar categoriesDropdown={categoriesDropdown} handleCategoriesDropdown={handleCategoriesDropdown} scrollToTop={scrollToTop}/>
      ...
      <Routes>
          ...
          <Route path="*" element={<div style={{display: "flex", justifyContent: "center", alignItems: "center", height: "75vh"} }><h1>404 Not Found</h1></div>} />
              ...
              <button className="back-to-top mobile" onClick={() => {window.scrollTo({top: 0, behavior: 'smooth'})}}>
                Back To Top
                {/* <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-circle-arrow-up"><circle cx="12" cy="12" r="10"/><path d="m16 12-4-4-4 4"/><path d="M12 16V8"/></svg> */}
              </button>
    </div>
  );
}
